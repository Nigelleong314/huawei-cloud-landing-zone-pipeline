...
def write_env(env_dir: Path, tfvars: dict, state_bucket: str, ak: str, sk: str, region: str, env_name: str):
    ...
    tfvars_path.write_text(json.dumps(tfvars, indent=2, sort_keys=False), encoding="utf-8")
    ...
    if env_name != "00-bootstrap" and state_bucket:
        ...
        backend_path.write_text(_render_backend_hcl(state_bucket, region, env_name), encoding="utf-8")
